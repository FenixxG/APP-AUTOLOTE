...
export const UsuarioRecuperarContrasena = 'usuarios/recuperar';
export const UsuarioActualizarContrasena = 'usuarios/actualizar';
export const UsuarioRegistrar = 'clientes/guardar';
